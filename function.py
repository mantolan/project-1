...
def speak(text, lang = "en"):
    ...
    audio = AudioSegment.from_file_using_temporary_files(tts.save_to_tempfile())
    play(audio)
...
def takeCommand():
    ...
    try:
        ...
        print(e)    
        speak("Unable to Recognizing your voice.")  
        return "None"
    return query
...
def main_code():
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            r = sr.Recognizer()
            results = r.recognize_google(results, language='en')
            print(results)
            speak(results)
            ...
            speak("I have been created by Team8.")
            ...
            speak("Thanks to Team8. further It's a secret")

        elif 'what is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by Team8")

        elif 'reason for your existence' in query:
            speak("I was created as a Minor project by Team8 ")

        elif 'change background' in query:
            ctypes.windll.user32.SystemParametersInfoW(20, 0, "C:\\Users\\OneDrive\\Minor Project\\Voice\\back.jpg" , 0)
        ...
        elif ' what is google news' in query:
            try:
        ...
        elif " what is bbc news" in query:
            try:
        ...
        elif 'what is news' in query or 'what is todays update' in query: #samachar
            try:
        ...
        elif 'lock window' in query or "can u lock my system" in query:
        ...
        elif "will you be my girlfriend" in query or "will you be my boyfriend" in query:   #most asked question from google Assistant
        ...
        elif "did u had food" in query or "food" in query or "breakfast" in query or "lunch" in query or "dinner" in query:
            speak("I had fully recovered, what about your food?")
        
        elif "do you like to date me" in query or "what about a date" in query:
            speak("I have a lot of people to date , but I will consider it interesting for sometime")
            ...
            if target_language in dic: # language
                target_language = dic[dic.index(target_language) + 1]
            ...
            try:
                ...
                print(translated_text in vars())
                print(translated_text in locals())
                print(translated_text)
                speak(translated_text, "ta")
            except Exception as e:
                print(e)
                speak(e)
                print("now got here")
                speak(translated_text.encode('ascii', 'ignore').decode('ascii'))
            del translator
            speak("translations complete")
        elif"open picture" in query:
            speak("Open picture"+ assname)
            pic = r"C:\Users\GK\Pictures\Screenshots"
            os.startfile(pic)
        
        elif " sing a song"in query or "song" in query or "what about a song" in query:
            speak("it's gonna be okay, it's gonna be okay, it's gonna be okay, it's gonna be okay, it's gonna be okay")
