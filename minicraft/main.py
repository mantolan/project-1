...
TAKE = tex_coords((2, 2), (2, 2), (2, 2))
ROAD = tex_coords((3, 2), (3, 2),(3, 2))
SNOW = tex_coords((0, 3), (0, 3), (0, 3))
ROCK = tex_coords((1, 3), (1, 3), (1, 3))
...
class Model(object):
    ...
    def _initialize(self):
        ...
        """
        gen = NoiseGen(231346 * 2)
        n = 300 # 1/2 width and height of world
        s = 1  # step size
        y = 0  # initial y height
        t = random.choice([GRASS, SNOW])
        ...
        for x in xrange(0, n + 1, s):
            for z in xrange(0, n + 1, s):
                ...
                for y in xrange(h - 1, 0, -1):
                    self.add_block((x, y, z), ROCK, immediate=False)
    ...
    def hit_test(self, position, vector, max_distance=15):
    ...
    def check_neighbors(self, position):
        """  hiding blocks that are not exposed and
        ensuring that all exposed blocks
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inventory = [GRASS, BRICK, SAND, WATER, CEMENT, WOOD, TAKE, ROAD, LEAF,SNOW,ROCK]
        ...
        self.label = pyglet.text.Label('', font_name='Arial', font_size=8,
            x=10, y=self.height - 10, anchor_x='right', anchor_y='top',
            color=(0, 0, 0, 150))
    ...
    def _update(self, dt):
        """  This is where most of the motion logic lives, along with gravity and collision detection.
