...
def load_user_data():
    ...
    for i in data_list:
        ...
        for data in temp3:
            temp_list2.append(float(data))
        temp_list.append(temp_list2)
        user_data_list.append(temp_list)
        temp_list = []
        temp_list2 = []
...
class Model(object):
    ...
    def _initialize(self):
        ...
        """
        gen = NoiseGen(12648940)

        n = 200 #size of the world
        s = 1  # step size
        ...
        if self.exclusive:
            ...
            if (button == mouse.RIGHT) or \
                ...
                if previous:
                    ...
                    self.model.user_data_list.append(temp)
            elif button == pyglet.window.mouse.LEFT and block:
                texture = self.model.world[block]
                if texture != STONE:
                    self.model.remove_block(block)
                    '''' for i in self.model.user_data_list:
                        if i[0] == block[0] and i[1] == block[1] and i[2] == block[2]:
                            self.model.user_data_list.remove(i)'''
        else:
